...
class ListaMulta(ListView):
    ...
    model = Multas
    template_name = 'gestion_multas/listado_multas.html'
...
class VistaMulta(DetailView):
    ...
    model = Multas
    template_name = 'gestion_multas/vista_multa.html'
    context_object_name = 'multas' 
...
class CrearMulta(SuccessMessageMixin, CreateView):
    ...
    template_name = 'gestion_multas/crear_multa.html'
...
class EliminarMulta(SuccessMessageMixin, DeleteView):
    ...
    model = Multas
    template_name = 'gestion_multas/eliminar_multa.html'
    success_url = reverse_lazy('listado_multas')
