...
class ListaPropietario(ListView):
    ...
    model = Propietario
    template_name = 'gestion_propietario/listado_propietarios.html'
...
class VistaPropietario(DetailView):
    ...
    model = Propietario
    template_name = 'gestion_propietario/vista_propietario.html'
...
class CrearPropietario(SuccessMessageMixin, CreateView):
    ...
    template_name = 'gestion_propietario/crear_propietario.html'
...
class EliminarPropietario(SuccessMessageMixin, DeleteView):
    ...
    model = Propietario
    template_name = 'gestion_propietario/eliminar_propietario.html'
    success_url = reverse_lazy('listado_propietarios')
...
class ListaLicencia(ListView):
    ...
    model = Licencia
    template_name = 'gestion_propietario/listado_licencias.html'
...
class VistaLicencia(DetailView):
    ...
    model = Licencia
    template_name = 'gestion_propietario/vista_licencia.html'
...
class CrearLicencia(SuccessMessageMixin, CreateView):
    ...
    template_name = 'gestion_propietario/crear_licencia.html'
...
class EliminarLicencia(SuccessMessageMixin, DeleteView):
    ...
    model = Licencia
    template_name = 'gestion_propietario/eliminar_Licencia.html'
    success_url = reverse_lazy('listado_licencias')
    def delete(self, request, *args, **kwargs):
        try:
            self.object = self.get_object()
