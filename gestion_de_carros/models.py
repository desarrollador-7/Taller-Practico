...
class Carro(models.Model):
    ...
    placa = models.CharField(max_length=50, verbose_name = 'Placa*', unique=True, blank=True, null=True) 
    ...
    class Meta:
        ...
        permissions = (
            ...
            ('listar_carros', 'Puede Consultar Carro'),
            ('actualizar_carro', 'Puede Actualizar Carro'),
            ('eliminar_carro', 'Puede Eliminar Carro'),
            ('detalle_carro', 'Puede Ver Detalle Carro'),  
